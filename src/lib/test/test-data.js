...
conditionalQuestionIB.actions.push({
  condition : 'IS_CLIENT',
...
const badParameterIB = {
  actions : [{ parameter : 'FOO', prompt : 'foo?', type : 'invalid' }],
}
...
const conditionStatementIB = {
  actions : [{ statement : 'Hi!', condition : 'false' }, { statement : 'Bye!' }],
}
